...
$site_url_alias = preg_replace('@https?://@', '', $config['siteurl']);
$site_url_alias = substr($site_url_alias, strpos($site_url_alias, '/'));

$url_parts = split('\?', $_SERVER['REQUEST_URI']);
$request_file = $url_parts[0];
$request_file = str_replace($site_url_alias, '', $request_file);
